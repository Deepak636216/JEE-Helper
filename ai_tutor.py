...
8. Show the complete solution ONLY after genuine effort
...
Remember: Your goal is to teach THINKING, not just answers!"""
...
Provide a COMPLETE, STEP-BY-STEP solution including:
1. What we're trying to find
2. Given information
3. Relevant physics concepts/laws
4. Formula(s) needed
5. Step-by-step calculation
6. Final answer with units
7. Key insights or common mistakes
